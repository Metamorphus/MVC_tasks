...
using Week8_1.Data;
using Week8_1.Models;

namespace Week8_1.Controllers
{
    public class MoviesController : Controller
    {
            ...
            string yearFrom, string yearTo)
        {
            ...
            {
                movies = movies.Where(x => x.ReleaseDate.Year >= Int32.Parse(yearFrom));
            }

            if (!String.IsNullOrEmpty(yearFrom))
            {
                movies = movies.Where(x => x.ReleaseDate.Year <= Int32.Parse(yearTo));
            }
